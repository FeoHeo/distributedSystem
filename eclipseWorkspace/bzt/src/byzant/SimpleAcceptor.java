...
//        otherOut.println("Confirmed:" + acceptId + ":" + biggestRoundId);
    ...
    public static void corrupt_action(PrintWriter[] nodeOutput , PrintWriter clientOutput , BufferedReader nodeIn) {	//Corrupted node action goes here
    	...
    	try {
			...
			System.out.println("Error simulating corrupt");
			e.printStackTrace();
		}
    }
    ...
    public static void main(String[] args) {	// For connection with Proposer
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            try (	
                Socket clientSocket = serverSocket.accept();	// Making client input/output
                ...
                int index = 0;
                for(int i=0 ; i<nodeNum ; i++) {	// Start a thread for other Acceptor
                ...
                while ((inputLine = in.readLine()) != null) {
                    ...
                    // Handling Proposer
                    String[] arr = inputLine.split(":");	// arr will store the arguments
